...
class RoomsAdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rooms_admin" do
    assert_difference('RoomsAdmin.count') do
      post rooms_admins_url, params: { rooms_admin: { body: @rooms_admin.body, name: @rooms_admin.name } }
    end
  ...
  test "should update rooms_admin" do
    patch rooms_admin_url(@rooms_admin), params: { rooms_admin: { body: @rooms_admin.body, name: @rooms_admin.name } }
